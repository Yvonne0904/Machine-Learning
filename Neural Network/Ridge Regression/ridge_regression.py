...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        self.l2_term = nodes.L2NormPenaltyNode(l2_reg=self.l2_reg, w=self.w,node_name = 'l2_term')
        self.objective = nodes.SumNode(a=self.square_loss, b=self.l2_term,node_name='l2_loss')
